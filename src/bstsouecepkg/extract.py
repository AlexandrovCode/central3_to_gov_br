...
### Override this abstract function.
    ...
    def parse(self, link):
        ...
        try:
            ...
            if self.FETCH_TYPE == 'Finacial_Information':
                edd['Finacial_Information'] = self.get_financial_information(link)
                return self.__map(edd, link)
...
### Out of the 7 empty function below
    ...
    def __links(self, link):
        ...
        data_keys = ['overview', "officership", "documents", "subsidiaries", "branches", "graph:shareholders", "Finacial_Information"]
